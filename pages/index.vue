<template>
  <section class="relative">
    ...
    <section id="tooltips">
      ...
      <div v-for="(tooltip, index) in tooltips" :key="tooltip.id" class="z-50" @dblclick="removeTooltip(index)">
        <UseDraggable :initialValue="{ x: tooltip.x, y: tooltip.y }" class="absolute z-50 text-xs"
          :storage-key="tooltip.id" storage-type="session">
    ...
    <svg ref="overlay"
      class="w-screen h-screen absolute left-0 top-0 border border-red-300 z-20 pointer-events-none"></svg>
